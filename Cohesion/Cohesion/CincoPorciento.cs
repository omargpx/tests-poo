...
namespace Cohesion
{
    public class CincoPorciento : ITipoCalculo
    {
            ...
            if (compra.valor >= 5000)
            {
                ...
                switch (compra.ciudadEnum)
                {
                    case CiudadEnum.BuenosAires:
                        ...
                        descuentoVal = (decimal)((combustibleAR + seguridadAR + compra.valor) * 0.5);
                        result = (decimal)(compra.valor - descuentoVal);

                        break;
                    case CiudadEnum.RioDeJaneiro:

                        descuentoVal = (decimal)((combustibleBA + seguridadBA + compra.valor) * 0.5);
                        result = (decimal)(compra.valor - descuentoVal);

                        break;
                    case CiudadEnum.Cusco:

                        descuentoVal = (decimal)((combustiblePE + seguridadPE + compra.valor) * 0.5);
                        result = (decimal)(compra.valor - descuentoVal);
                    ...
                    case CiudadEnum.Santiago:
                        ...
                        descuentoVal = (decimal)((combustibleCH + seguridadCH + compra.valor) * 0.5);
                        result = (decimal)(compra.valor - descuentoVal);
                    ...
                    case CiudadEnum.Quito:
                        ...
                        descuentoVal = (decimal)((combustibleBL + seguridadBL + compra.valor) * 0.5);
                        result = (decimal)(compra.valor - descuentoVal);
                    ...
                    case CiudadEnum.Montevideo:
                        ...
                        descuentoVal = (decimal)((combustibleUR + seguridadUR + compra.valor) * 0.5);
                        result = (decimal)(compra.valor - descuentoVal);
